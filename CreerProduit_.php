...
<html>
    <head>
        <meta charset="UTF-8">
        <link rel="stylesheet" href="CreerProduit_v2.css">
    ...
    <body>
        ...
        <form action="VoirProduits.php" method="POST">
            ...
            <fieldset>
                ...
                <input type="text" name="libelle" id="lib" required minlength="3"/>
                ...
                <input type="number" name="quantite" id="qte" required/>
                <label for="prix">Prix unitaire (ex: 10.00)</label>
                <input type="text" placeholder="0.00" id="prix" name="prix" required pattern="[0-9]+.[0-9]{2}"/>
                <label for="tva">TVA</label> <input type="text" name="tva" id="tva" required/>
